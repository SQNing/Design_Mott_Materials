...
- Read `references/input-schema.md` for required normalized fields and `references/fallback-rules.md` whenever an unsupported or ambiguous branch is triggered.
